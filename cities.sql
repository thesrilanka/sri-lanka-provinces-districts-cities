...
CREATE TABLE `cities` (
  ...
  CONSTRAINT `fk_cities_districts1` FOREIGN KEY (`district_id`) REFERENCES `districts` (`id`)
...
(787,	11,	'Gunnepana',	'ගුන්නෙපන',	'குன்னெபன',	NULL,	NULL,	NULL,	'20270',	7.32286100,	80.65913260),
...
(793,	11,	'Hanguranketha',	'හඟුරන්කෙත',	'ஹங்குரன்கெத',	NULL,	NULL,	NULL,	'20710',	7.29057150,	80.63372620),
...
(813,	11,	'Kolabissa',	'කොලබිස්ස',	'கோலாபிஸ்ஸா',	NULL,	NULL,	NULL,	'20212',	7.16928430,	80.73246460),
...
(836,	11,	'Marymount Colony',	'මේරිමවුන්ට් ජනපදය',	'மேரிமவுண்ட் காலனி',	NULL,	NULL,	NULL,	'20714',	7.29057150,	80.63372620),
...
(874,	11,	'Rantembe',	'රන්ටෙඹේ',	'ராண்டெம்பே',	NULL,	NULL,	NULL,	'20990',	7.19960590,	80.94962880),
